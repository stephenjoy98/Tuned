<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPage1.master" AutoEventWireup="true" CodeBehind="SellerSignUp.aspx.cs" Inherits="Tuned.seller.SellerSignUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style23">
        ...
        <tr>
            <td class="auto-style36" style="font-family: 'Trebuchet MS'"><strong>Email:&nbsp; </strong> </td>
        ...
        <tr>
            <td class="auto-style36" style="font-family: 'Trebuchet MS'"><strong>Contact No:&nbsp; </strong> </td>
            <td class="auto-style37">&nbsp;
        ...
        <tr>
            <td class="auto-style36" style="font-family: 'Trebuchet MS'"><strong>Password:&nbsp; </strong> </td>
            <td class="auto-style37">&nbsp;
