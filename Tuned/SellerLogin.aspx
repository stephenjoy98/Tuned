<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPage1.Master" AutoEventWireup="true" CodeBehind="SellerLogin.aspx.cs" Inherits="Tuned.seller.SellerLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style99">
        <tr>
            <td class="auto-style108" colspan="8">
                <h1><strong>Seller Login</strong></h1>
            </td>
        </tr>
        <tr>
